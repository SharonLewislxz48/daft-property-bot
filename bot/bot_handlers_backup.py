...
from bot.keyboards import (
    ...
    get_statistics_keyboard,         await callback.message.edit_text(
        ...
        try:
            ...
            logger.warning(f"Timeout callback answer: {e}")
        
        # Отправляем все результаты
        await self._send_all_properties(user_id, results)_regions_keyboard
)
