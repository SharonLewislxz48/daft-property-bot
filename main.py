...
from bot.bot import EnhancedPropertyBot
from bot.bot_handlers import EnhancedPropertyBotHandlers
...
class CombinedBot(EnhancedPropertyBot, EnhancedPropertyBotHandlers):
    ...
    def _register_handlers(self):
        ...
        self.dp.callback_query.register(self.callback_replace_all_regions, F.data == "replace_all_regions")
        ...
        # Обработчики для режима замены регионов
        self.dp.callback_query.register(
            self.callback_replace_category_selection,
            F.data.startswith("replace_category_")
        )
        self.dp.callback_query.register(
        ...
        # Обработчик для режима замены регионов
        self.dp.callback_query.register(
            self.callback_replace_select_region,
            F.data.startswith("replace_select_region_")
        )
        self.dp.callback_query.register(
